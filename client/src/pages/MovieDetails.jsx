...
useEffect(()=>{
  ...
  return show ? (
    <div className='flex flex-col md:flex-row flex-wrap gap-8 max-w-6xl mx-auto pt-40'>
      ...
      <div className='relative flex flex-col gap-3'>
        ...
        <div className='flex items-center flex-wrap gap-4 mt-4'>
          <button onClick={()=> {navigate('/'); scrollTo(0,1500)}} className='flex items-center gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-900 transition rounded-md font-medium
      ...
      <p className='text-lg font-medium mt-20 w-full'>Your Favorite Cast</p>
      ...
      <div className='flex w-full justify-center mt-20'>
          ...
          corsor-pointer'>Show More</button>
      </div>
